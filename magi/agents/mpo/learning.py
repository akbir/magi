...
class MPOLearner(acme.Learner):
    ...
    def __init__(
        ...
        def compute_loss(
            ...
            o_t = jax.lax.stop_gradient(transitions.next_observation)
            ...
            q_tm1 = critic_network.apply(
                critic_params, o_tm1, transitions.action
            )  # [B]
            ...
            # Actor learning.
            policy_loss, policy_stats, mpo_params = policy_loss_fn(
                mpo_params,
            ...
            return (jnp.mean(policy_loss), critic_loss), (policy_stats, mpo_params)
        ...
        def sgd_step(state: TrainingState, transitions: acme_types.Transition):
            ...
            (
                (policy_loss_value, critic_loss_value),
                vjpfun,
                (policy_metrics, mpo_params),
            ) = jax.vjp(
